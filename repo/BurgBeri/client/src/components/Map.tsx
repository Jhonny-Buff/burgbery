export function Map() {
  return (
    <div className="w-full h-72 md:h-96 rounded-2xl overflow-hidden border border-zinc-800 mb-8 md:mb-12" data-testid="map-container">
      <iframe
        ...
        title="Карта местоположения Бургбери"
      />
    </div>
  );
}
